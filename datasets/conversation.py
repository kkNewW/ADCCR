...
def build_keypoint_conversation(description, question, answer=None):
    conv = conv_keypoint.copy()
    conv.messages = []
    conv.append_message("Keypoint", description)
    conv.append_message("Question", question)
    if answer is not None:
        conv.append_message("Answer", answer)
    return conv


def build_keypoint_prompt(description, question, answer=None):
    conv = build_keypoint_conversation(description, question, answer)
